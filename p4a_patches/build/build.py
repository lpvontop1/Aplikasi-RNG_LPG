...
def run_pymodules_install(ctx, arch, modules, project_dir=None,
    ...
    with current_directory(join(ctx.build_dir)):
        ...
        # NOTE: Skip 'pip install -U pip' because pip 25.x has a broken
        # resolvelib bundle (conflicting resolvers/ folder vs resolvers.py).
        # The venv's pip (inherited from host) works fine.
        info('Skipping pip upgrade (broken resolvelib in newer pip)')
